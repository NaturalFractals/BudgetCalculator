...
export class GaugeChart {
    ...
    createChartTuple(masterBudget) {
        ...
        // totalObject.y = Math.max(100, parseInt(masterBudget.sumOfAllCost) / parseInt(masterBudget.totalMonthlyIncome) * 100);
        totalObject.push(80.0);
        var remainingObject = [];
        remainingObject.push('Income');
        // remainingObject.y = Math.max,(0, ((parseInt(masterBudget.totalMonthlyIncome) - parseInt(masterBudget.sumOfAllCost)) / parseInt(masterBudget.totalMonthlyIncome) * 100));
