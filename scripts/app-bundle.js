...
define('auto-budget/auto-budget',['exports', 'aurelia-framework', 'aurelia-router'], function (exports, _aureliaFramework, _aureliaRouter) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.AutoBudget = undefined;
    ...
    var AutoBudget = exports.AutoBudget = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router), _dec(_class = function () {
        function AutoBudget(router) {
            _classCallCheck(this, AutoBudget);

            this.router = router;
        }

        AutoBudget.prototype.routeResults = function routeResults() {
...
define('five-year/five-year',['exports', 'aurelia-framework', 'aurelia-router'], function (exports, _aureliaFramework, _aureliaRouter) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.FiveYear = undefined;
    ...
    var FiveYear = exports.FiveYear = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router), _dec(_class = function () {
        function FiveYear(router) {
            _classCallCheck(this, FiveYear);

            this.router = router;
        }

        FiveYear.prototype.routeResults = function routeResults() {
            this.router.navigate("#/results");
        };
...
define('goals/goals',['exports', 'goals/goal', 'aurelia-framework', 'masterBudget', 'aurelia-router'], function (exports, _goal, _aureliaFramework, _masterBudget, _aureliaRouter) {
    'use strict';
    ...
    var Goals = exports.Goals = (_dec = (0, _aureliaFramework.inject)(_masterBudget.MasterBudget, _aureliaRouter.Router), _dec(_class = function () {
        function Goals(masterBudget, router) {
        ...
        Goals.prototype.routeResults = function routeResults() {
            this.router.navigate('#/results');
        };
...
define('intro/intro',['exports', 'aurelia-framework', 'aurelia-router', 'aurelia-fetch-client', '../utilities/chartFactory', 'masterBudget'], function (exports, _aureliaFramework, _aureliaRouter, _aureliaFetchClient, _chartFactory, _masterBudget) {
    ...
    var Intro = exports.Intro = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaFetchClient.HttpClient, _masterBudget.MasterBudget), _dec(_class = function () {
        ...
        Intro.prototype.getLocation = function () {
            var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(userInput) {
        ...
        Intro.prototype.test = function test(clickAction) {
            var self = this;
            this.masterBudget.numberAdults = clickAction + 1;
            var federalSingle = [0, 9325, 37950, 91900, 191650, 416700, 418401, 100000000000];
            var federalSinglePercent = [0.1, 0.15, 0.25, 0.28, 0.33, 0.35, 0.40, 0.3960];
            var federalMarried = [0, 18650, 75900, 153100, 233350, 416700, 470700, 1000000000];
            var federalMarriedPercent = [0.1, 0.15, 0.25, 0.28, 0.33, 0.33, 0.35, 0.3960];
            var count = 0;
            var index = -1;
            if (clickAction + 1 == 1) {
                federalSingle.forEach(function (value) {
                    count += 1;
                ...
                federalMarried.forEach(function (value) {
                    count++;
                    if (self.income <= value && index == -1) {
                        index = count;
                    }
        ...
        Intro.prototype.test2 = function test2(clickAction) {
        ...
        Intro.prototype.getCurrentLocation = function getCurrentLocation(jsonData, userInput) {
            var array = jsonData.results[4].formatted_address.split(",");
            if (!userInput) this.masterBudget.location = array[0];
        };

        Intro.prototype.route = function route() {
            if (this.masterBudget.numberChildren == 0) this.masterBudget.childCare.cost = 0;
        ...
        Intro.prototype.getMonthlyIncome = function () {
            var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
                var _this = this;

                var self, stateTax, stateTaxData;
                return regeneratorRuntime.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            ...
                            case 3:
                                stateTax = _context4.sent;
                                _context4.next = 6;
                                return stateTax.json();

                            case 6:
                                stateTaxData = _context4.sent;

                                stateTaxData.taxes.forEach(function (state) {
                                    if (self.masterBudget.stateLocation == state[0] && self.income < state[2]) {
                                        ...
                                        self.masterBudget.totalMonthlyIncome = parseInt(_this.income) / 12;
                                        self.masterBudget.savings.cost = _this.income * 0.15;
                                    }
                                });
...
define('budget-breakdown-module/category-modules/transportation/transportation',['exports', 'aurelia-framework', 'constants', 'aurelia-event-aggregator'], function (exports, _aureliaFramework, _constants, _aureliaEventAggregator) {
    ...
    var Transportation = exports.Transportation = (_dec = (0, _aureliaFramework.inject)(_constants.Constants, _aureliaEventAggregator.EventAggregator), _dec2 = (0, _aureliaFramework.singleton)(), _dec(_class = _dec2(_class = function () {
        ...
        Transportation.prototype.calculateAdvancedTransportationCost = function calculateAdvancedTransportationCost() {
            var scale = this.isMonthly ? 1 : 1 / 12;
            this.cost = parseInt((parseInt(this.carYearlyUpkeepCost) + parseInt(this.carMonthlyOwnershipCost) + parseInt(this.repairCost) + parseInt(this.gasCost) + parseInt(this.insuranceCost) + parseInt(this.paymentCost)) * scale);
...
define('text!five-year/card-info-child-care.html', ['module'], function(module) { module.exports = "<template>Ask your employer about workplace benefits , some offer discounts for their employees!</template>"; });
define('text!five-year/card-info-food.html', ['module'], function(module) { module.exports = "<template>Try dining out less and packing your own lunch. Did you know you can save around $12.00 each week if you make a cup of coffee at home!</template>"; });
define('text!five-year/card-info-housing.html', ['module'], function(module) { module.exports = "<template>The government offers taxpayer credits for certain alternative energy sources. Consider becoming more energy efficient!</template>"; });
define('text!five-year/card-info-medical.html', ['module'], function(module) { module.exports = "<template>Ask about options or discounts before securing services. Sometimes paying in cash earns you a discount!</template>"; });
define('text!five-year/card-info-other.html', ['module'], function(module) { module.exports = "<template>If you don’t use your gym membership as much as you like, cancel it! Try outdoor activities that are free like tennis, hiking, or running.</template>"; });
define('text!five-year/card-info-savings.html', ['module'], function(module) { module.exports = "<template>Sometimes you should cut back on savings for a bit. Cut back by 5 or 10% for a few months until you can afford it.</template>"; });
define('text!five-year/card-info-taxes.html', ['module'], function(module) { module.exports = "<template>Adjust your withholdings to receive more money per paycheck. Be careful, you may pay more when the tax deadline comes!</template>"; });
define('text!five-year/card-info-transportation.html', ['module'], function(module) { module.exports = "<template>Think about carpooling with a co-worker or friend to save money on gas! You can also shop around and compare insurance costs.</template>"; });
define('text!five-year/donut-details.html', ['module'], function(module) { module.exports = "<template><require from=\"../utilities/currency\"></require><require from=\"../utilities/percent\"></require><nav class=\"navbar navbar-light teal\"><div class=\"container-fluid\"><ul repeat.for=\"category of masterBudget.budgetCategories\" class=\"nav navbar-nav\"><li class=\"${category === currentCategory ? 'active': ''}\"><a click.delegate=\"changeNavigationTab(category)\">${category}</a></li></ul></div></nav><div><h2 style=\"padding:10px\">Your monthly ${currentCategory} expense in ${currentYear} is ${currentExpense | currency}.</h2><br><div><h3 style=\"padding:10px\">Tip to save:</h3><h4 style=\"padding:10px\" if.bind=\"currentCategory == 'Child Care'\">Ask your employer about workplace benefits , some offer discounts for their employees!</h4><h4 style=\"padding:10px\" if.bind=\"currentCategory == 'Medical'\">Ask about options or discounts before securing services. Sometimes paying in cash earns you a discount!</h4><h4 style=\"padding:10px\" if.bind=\"currentCategory == 'Food'\">Try dining out less and packing your own lunch. Did you know you can save around $12.00 each week if you make a cup of coffee at home!</h4><h4 style=\"padding:10px\" if.bind=\"currentCategory == 'Transportation'\">Think about carpooling with a co-worker or friend to save money on gas! You can also shop around and compare insurance costs.</h4><h4 style=\"padding:10px\" if.bind=\"currentCategory == 'Other'\">If you don’t use your gym membership as much as you like, cancel it! Try outdoor activities that are free like tennis, hiking, or running.</h4><h4 style=\"padding:10px\" if.bind=\"currentCategory == 'Savings'\">Sometimes you should cut back on savings for a bit. Cut back by 5 or 10% for a few months until you can afford it.</h4><h4 style=\"padding:10px\" if.bind=\"currentCategory == 'Taxes'\">Use a Certified Public Accountant or Professional Tax Service to maximize your tax savings opportunities.</h4><h4 style=\"padding:10px\" if.bind=\"currentCategory == 'Housing'\">The government offers taxpayer credits for certain alternative energy sources. Consider becoming more energy efficient!</h4></div></div></template>"; });
define('text!five-year/five-year.html', ['module'], function(module) { module.exports = "<template><div id=\"five-year-module-container\"><div class=\"row\"><div id=\"content-header\"><h1 style=\"font-size:36px;text-align:center;margin-bottom:40px\"><b>Five Year Plan<b></b></b></h1></div><div class=\"progress\" style=\"margin-bottom:5vh\"><div class=\"progress-bar\" style=\"width:100%\"></div></div><div id=\"goals-chart-div\" class=\"card\"><compose view-model=\"chart/donut-chart\" view-model.ref=\"chartVM\"></compose></div><div id=\"donut-details\" class=\"card\"><compose view-model=\"./donut-details\"></compose></div></div><button type=\"button\" class=\"col-md-2 btn btn-raised btn-primary\" style=\"margin:10vh 55vh\" click.delegate=\"routeResults()\">Back</button></div></template>"; });
define('text!goals/goals.html', ['module'], function(module) { module.exports = "<template><require from=\"css/styles.css\"></require><require from=\"../utilities/currency\"></require><div><h1 id=\"content-header\" style=\"font-size:36px;text-align:center;margin-left:0\"><b>Goals<b></b></b></h1></div><br><div class=\"progress\" style=\"margin:0 20vw\"><div class=\"progress-bar\" style=\"width:100%\"></div></div><div id=\"goal-template\"><div><h2>How much will you need to save reach your goals?</h2><br><h4>Enter your goals to find out your necessary monthly savings.</h4></div></div><table id=\"goal-template\" class=\"table table-striped table-hover\"><thead><tr><th>Goal</th><th>Cost</th><th>Purchase Month</th><th>Purchase Year</th><th></th></tr></thead><tbody><tr><td><div class=\"form-group form-inline\"><div class=\"col-md-10\"><input type=\"text\" class=\"form-control\" id=\"inputGoal\" placeholder=\"Boat\" value.bind=\"selectedName\"></div></div></td><td><div class=\"form-group form-inline\"><div class=\"col-md-10\"><input type=\"number\" class=\"form-control\" id=\"inputCost\" placeholder=\"8000\" value.bind=\"selectedCost\"></div></div></td><td><div class=\"form-group form-inline\"><div class=\"col-md-10\"><select id=\"inputMonth\" class=\"form-control\" value.bind=\"selectedMonth\"><option repeat.for=\"month of months\" value.bind=\"month\">${month}</option></select></div></div></td><td><div class=\"form-group form-inline\"><div class=\"col-md-10\"><input type=\"number\" class=\"form-control\" id=\"inputYear\" placeholder=\"2019\" value.bind=\"selectedYear\"></div></div></td><td><button class=\"btn btn-raised btn-info\" click.delegate=\"addGoal()\">Add Goal</button></td></tr><tr repeat.for=\"goal of goalsList\"><td>${goal.name}</td><td>${goal.cost}</td><td>${goal.month}</td><td>${goal.year}</td><td><button class=\"btn btn-raised btn-danger\" click.delegate=\"removeGoal($index)\">Remove Goal</button></td></tr></tbody></table><div id=\"panel-goals\" class=\"panel panel-primary\" if.bind=\"goalsList.length > 0\"><div class=\"panel-heading\"><h3 id=\"panel-title-heading\" class=\"panel-title\">Goal Budget</h3></div><div class=\"panel-body\"><div id=\"goals-results-text\">You must save ${monthlySavings | currency} a month to afford these goals.</div></div></div><button type=\"button\" class=\"col-md-2 btn btn-raised btn-primary\" style=\"margin:5vh 42vw\" click.delegate=\"routeResults()\">Back</button></template>"; });
define('text!intro/intro.html', ['module'], function(module) { module.exports = "<template><require from=\"css/styles.css\"></require><div class=\"view overlay hm-blue-light\" id=\"intro-template\"><h1 id=\"intro-page-title\" class=\"text-center\">Budget Planning</h1><div class=\"card\" id=\"intro-card\"><form><div id=\"intro-form\" class=\"form-group\"><label for=\"\"><b>Annual Income:</b></label><input type=\"text\" class=\"form-control\" placeholder=\"$50,000\" value.bind=\"masterBudget.annualIncome\" change.delegate=\"sanitizeIncome() getMonthlyIncome() getLocation(true)\"></div><div id=\"intro-form\" class=\"form-group\"><label for=\"\"><b>Location:</b></label><input type=\"text\" class=\"form-control\" value.bind=\"masterBudget.location\"></div><div class=\"btn-toolbar\" role=\"toolbar\" id=\"adults-toolbar\"><b style=\"margin:0 auto\">Adults in Household</b><div class=\"btn-group btn-group-justified btn-group-raised\" data-toggle=\"buttons\"><label click.delegate=\"test(i)\" id=\"adult-intro-button\" repeat.for=\"i of 2\" class=\"btn btn-raised btn-primary\"><input type=\"radio\" checked.bind=\"masterBudget.numberAdults\" value.bind=\"i + 1\" name=\"options\"> ${i + 1}</label></div></div><br><div class=\"btn-toolbar\" role=\"toolbar\" id=\"children-toolbar\"><b>Children in Household</b><div class=\"btn-group btn-group-justified btn-group-raised\" data-toggle=\"buttons\"><label click.delegate=\"test2(i)\" id=\"children-intro-button\" repeat.for=\"i of 5\" class=\"btn btn-raised btn-primary\"><input type=\"radio\" checked.bind=\"masterBudget.numberChildren\" value.bind=\"i + 1\" name=\"options\"> ${i}</label></div></div><br><div id=\"budgetButton\"><button class=\"btn btn-lg btn-raised btn-info\" click.delegate=\"route() getMonthlyIncome()\">Budget</button></div></form></div></div></template>"; });
define('text!results/results.html', ['module'], function(module) { module.exports = "<template><div id=\"content-header\"><h1 style=\"background:#e0f2f1;font-size:36px;text-align:center\"><b>Budget Planning<b></b></b></h1></div><br><compose view-model=\"results-banner-module/banner\"></compose><div style=\"background:#e0f2f1\"><div id=\"results-container\" class=\"row\"><div id=\"chart-div\" class=\"column-md-1\" style=\"width:30vw\"><compose view-model=\"chart/chart\" view-model.ref=\"chartVM\"></compose></div><div id=\"breakdown-div\" class=\"column-md-1\" style=\"width:35vw\"><compose view-model=\"budget-breakdown-module/breakdown\"></compose></div><div class=\"button-group\" id=\"button-div\"><button type=\"button\" class=\"btn btn-raised btn-primary\" click.delegate=\"routeGoals()\">Goals</button> <button type=\"button\" class=\"btn btn-raised btn-primary\" click.delegate=\"routeFiveYearPlan()\">Five Year Plan</button> <button type=\"button\" class=\"btn btn-raised btn-primary\" click.delegate=\"routeAutoBudget()\">Auto Budget</button></div></div></div></template>"; });
define('text!results-banner-module/banner.html', ['module'], function(module) { module.exports = "<template><table id=\"banner-table\" class=\"table card\" style=\"margin:0 12vw\"><tr><td><div><label id=\"breakdown-header-label\" for=\"\"><b>Annual Income:</b></label><input type=\"text\" class=\"form-control\" placeholder=\"50,000\" value.bind=\"masterBudget.annualIncome\" change.delegate=\"sanitizeIncome() getMonthlyIncome()\"></div></td><td><div><label id=\"breakdown-header-label\" for=\"\"><b>Location:</b></label><input type=\"text\" value.bind=\"masterBudget.location\" class=\"form-control\"></div></td><td><div id=\"breakdown-buttons\" class=\"btn-toolbar\" role=\"toolbar\"><b>Adults in Household</b><div class=\"radio-group\" data-toggle=\"buttons\"><label id=\"breakdown-buttons-label\" repeat.for=\"i of 2\" class=\"btn btn-sm btn-raised btn-primary\"><input type=\"radio\" checked.bind=\"masterBudget.numberAdults\" value.bind=\"i + 1\" name=\"options\"> ${i + 1}</label></div></div></td><td><div id=\"breakdown-buttons\" class=\"btn-toolbar\" role=\"toolbar\"><b>Children in Household</b><div class=\"radio-group\" data-toggle=\"buttons\"><label id=\"breakdown-buttons-label\" repeat.for=\"i of 5\" class=\"btn btn-sm btn-raised btn-primary\"><input type=\"radio\" checked.bind=\"masterBudget.numberChildren\" value.bind=\"i\" name=\"options\"> ${i}</label></div></div></td></tr></table></template>"; });
define('text!budget-breakdown-module/category-modules/child-care/child-care.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../utilities/currency\"></require><require from=\"../../../utilities/percent\"></require><link rel=\"stylesheet\" href=\"//cdnjs.cloudflare.com/ajax/libs/font-awesome/4.2.0/css/font-awesome.min.css\"><div class=\"card\"><div class=\"card-header\" role=\"tab\" id=\"headingOne\"><dv class=\"col-md-4\"><h5 class=\"mb-0\"><div class=\"checkbox checkbox-child-care checkbox-inline\"><input id=\"checkbox1\" type=\"checkbox\" checked.bind=\"includeInBudget\" change.delegate=\"eventAggregator.publish('toggle element', 'Child Care')\"><label for=\"checkbox1\"></label></div><a click.delegate=\"toggle()\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapseChildCare\" aria-expanded=\"true\" aria-controls=\"collapseChildCare\">Child Care<span class=\"${collapsed ? 'glyphicon glyphicon-chevron-down arrows' : 'glyphicon glyphicon-chevron-up arrows'}\"></span></a></h5></dv></div><div class=\"col-md-4\"></div><div class=\"col-md-4\"><span class=\"${includeInBudget ? 'blackparagraph' : 'grayparagraph'}\">${cost | currency}</span><span class=\"permonth\">&nbsp&nbsp&nbsp/ Month</span></div><br><br><br><div id=\"collapseChildCare\" class=\"collapse\" role=\"tabpanel\" aria-labelledby=\"headingChildCare\"><div class=\"card-block\"><div class=\"btn-group btn-group-raised\" data-toggle=\"buttons\" click.delegate=\"toggleHorizon()\"><label class=\"btn btn-sm ${isMonthly ? 'btn-primary' : 'btn-secondary'}\">Monthly</label><label class=\"btn btn-sm ${!isMonthly ? 'btn-primary' : 'btn-secondary'}\">Yearly</label></div><div repeat.for=\"constant of constants.childCare\" class=\"form-group\"><div class=\"input-group mb-2 mr-sm-2 mb-sm-0\"><label>${constant.label}</label><input type=\"number\" value.bind=\"$parent[constant.variable]\" change.delegate=\"calculateAdvancedChildCareCost()\"></div></div></div></div></div></template>"; });
define('text!budget-breakdown-module/category-modules/food/food.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../utilities/currency\"></require><require from=\"../../../utilities/percent\"></require><div class=\"card\"><div class=\"card-header\" role=\"tab\" id=\"headingFood\"><div class=\"col-md-4\"><h5 class=\"mb-0\"><div class=\"checkbox checkbox-food checkbox-inline\"><input id=\"checkbox2\" type=\"checkbox\" checked.bind=\"includeInBudget\" change.delegate=\"eventAggregator.publish('toggle element', 'Food')\"><label for=\"checkbox2\"></label></div><a click.delegate=\"toggle()\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapseFood\" aria-expanded=\"true\" aria-controls=\"collapseFood\">Food <span class=\"${collapsed ? 'glyphicon glyphicon-chevron-down arrows' : 'glyphicon glyphicon-chevron-up arrows'}\"></span></a></h5></div><div class=\"col-md-4\"></div><div class=\"col-md-4\"><span class=\"${includeInBudget ? 'blackparagraph' : 'grayparagraph'}\">${cost | currency}</span><span class=\"permonth\">&nbsp&nbsp&nbsp/ Month</span></div></div><br><br><br><div id=\"collapseFood\" class=\"collapse\" role=\"tabpanel\" aria-labelledby=\"headingFood\"><div class=\"card-block\"><div class=\"btn-group btn-group-raised\" data-toggle=\"buttons\" click.delegate=\"toggleHorizon()\"><label class=\"btn btn-sm ${isMonthly ? 'btn-primary' : 'btn-secondary'}\">Monthly</label><label class=\"btn btn-sm ${!isMonthly ? 'btn-primary' : 'btn-secondary'}\">Yearly</label></div><div repeat.for=\"constant of constants.food\" class=\"form-group\"><div class=\"input-group mb-2 mr-sm-2 mb-sm-0\"><label for=\"food-input\">${constant.label}</label><input type=\"number\" value.bind=\"$parent[constant.variable]\" change.delegate=\"calculateAdvancedFoodCost()\"></div></div></div></div></div></template>"; });
define('text!budget-breakdown-module/category-modules/housing/housing.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../utilities/currency\"></require><require from=\"../../../utilities/percent\"></require><div class=\"card\"><div class=\"card-header\" role=\"tab\" id=\"headingHousing\"><div class=\"col-md-4\"><h5 class=\"mb-0\"><div class=\"checkbox checkbox-housing checkbox-inline\"><input id=\"checkbox3\" type=\"checkbox\" checked.bind=\"includeInBudget\" change.delegate=\"eventAggregator.publish('toggle element', 'Housing')\"><label for=\"checkbox3\"></label></div><a click.delegate=\"toggle()\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapseHousing\" aria-expanded=\"true\" aria-controls=\"collapseHousing\">Housing <span class=\"${collapsed ? 'glyphicon glyphicon-chevron-down arrows' : 'glyphicon glyphicon-chevron-up arrows'}\"></span></a></h5></div><div class=\"col-md-4\"></div><div class=\"col-md-4\"><span class=\"${includeInBudget ? 'blackparagraph' : 'grayparagraph'}\">${cost | currency}</span><span class=\"permonth\">&nbsp&nbsp&nbsp/ Month</span></div></div><br><br><br><div id=\"collapseHousing\" class=\"collapse\" role=\"tabpanel\" aria-labelledby=\"headingHousing\"><div class=\"card-block\"><div class=\"btn-group btn-group-raised\" data-toggle=\"buttons\" click.delegate=\"toggleHorizon()\"><label class=\"btn btn-sm ${isMonthly ? 'btn-primary' : 'btn-secondary'}\">Monthly</label><label class=\"btn btn-sm ${!isMonthly ? 'btn-primary' : 'btn-secondary'}\">Yearly</label></div><div repeat.for=\"constant of constants.housing\" class=\"form-group\"><div class=\"input-group mb-2 mr-sm-2 mb-sm-0\"><label>${constant.label}</label><input type=\"number\" value.bind=\"$parent[constant.variable]\" change.delegate=\"calculateAdvancedCost()\"></div></div></div></div></div></template>"; });
define('text!budget-breakdown-module/category-modules/medical/medical.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../utilities/currency\"></require><require from=\"../../../utilities/percent\"></require><div class=\"card\"><div class=\"card-header\" role=\"tab\" id=\"headingMedical\"><div class=\"col-md-4\"><h5 class=\"mb-0\"><div class=\"checkbox checkbox-medical checkbox-inline\"><input id=\"checkbox4\" type=\"checkbox\" checked.bind=\"includeInBudget\" change.delegate=\"eventAggregator.publish('toggle element', 'Medical')\"><label for=\"checkbox4\"></label></div><a click.delegate=\"toggle()\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapseMedical\" aria-expanded=\"true\" aria-controls=\"collapseMedical\">Medical <span class=\"${collapsed ? 'glyphicon glyphicon-chevron-down arrows' : 'glyphicon glyphicon-chevron-up arrows'}\"></span></a></h5></div><div class=\"col-md-4\"></div><div class=\"col-md-4\"><span class=\"${includeInBudget ? 'blackparagraph' : 'grayparagraph'}\">${cost | currency}</span><span class=\"permonth\">&nbsp&nbsp&nbsp/ Month</span></div></div><br><br><br><div id=\"collapseMedical\" class=\"collapse\" role=\"tabpanel\" aria-labelledby=\"headingMedical\"><div class=\"card-block\"><div class=\"btn-group btn-group-raised\" data-toggle=\"buttons\" click.delegate=\"toggleHorizon()\"><label class=\"btn btn-sm ${isMonthly ? 'btn-primary' : 'btn-secondary'}\">Monthly</label><label class=\"btn btn-sm ${!isMonthly ? 'btn-primary' : 'btn-secondary'}\">Yearly</label></div><div repeat.for=\"constant of constants.medical\" class=\"form-group\"><div class=\"input-group mb-2 mr-sm-2 mb-sm-0\"><label>${constant.label}</label><input type=\"number\" value.bind=\"$parent[constant.variable]\" change.delegate=\"calculateAdvancedMedical()\"></div></div></div></div></div></template>"; });
define('text!budget-breakdown-module/category-modules/other/other.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../utilities/currency\"></require><require from=\"../../../utilities/percent\"></require><div class=\"card\"><div class=\"card-header\" role=\"tab\" id=\"headingOther\"><div class=\"col-md-4\"><h5 class=\"mb-0\"><div class=\"checkbox checkbox-other checkbox-inline\"><input id=\"checkbox5\" type=\"checkbox\" checked.bind=\"includeInBudget\" change.delegate=\"eventAggregator.publish('toggle element', 'Other')\"><label for=\"checkbox5\"></label></div><a click.delegate=\"toggle()\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapseOther\" aria-expanded=\"true\" aria-controls=\"collapseOther\">Other <span class=\"${collapsed ? 'glyphicon glyphicon-chevron-down arrows' : 'glyphicon glyphicon-chevron-up arrows'}\"></span></a></h5></div><div class=\"col-md-4\"></div><div class=\"col-md-4\"><span class=\"${includeInBudget ? 'blackparagraph' : 'grayparagraph'}\">${cost | currency}</span><span class=\"permonth\">&nbsp&nbsp&nbsp/ Month</span></div></div><br><br><br><div id=\"collapseOther\" class=\"collapse\" role=\"tabpanel\" aria-labelledby=\"headingOther\"><div class=\"card-block\"><div class=\"btn-group btn-group-raised\" data-toggle=\"buttons\" click.delegate=\"toggleHorizon()\"><label class=\"btn btn-sm ${isMonthly ? 'btn-primary' : 'btn-secondary'}\">Monthly</label><label class=\"btn btn-sm ${!isMonthly ? 'btn-primary' : 'btn-secondary'}\">Yearly</label></div><div repeat.for=\"constant of constants.other\" class=\"form-group\"><div class=\"input-group mb-2 mr-sm-2 mb-sm-0\"><label>${constant.label}</label><input type=\"number\" value.bind=\"$parent[constant.variable]\" change.delegate=\"calculateAdvancedOtherCost()\"></div></div></div></div></div></template>"; });
define('text!budget-breakdown-module/category-modules/savings/savings.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../utilities/currency\"></require><require from=\"../../../utilities/percent\"></require><div class=\"card\"><div class=\"card-header\" role=\"tab\" id=\"headingSavings\"><div class=\"col-md-4\"><h5 class=\"mb-0\"><div class=\"checkbox checkbox-savings checkbox-inline\"><input id=\"checkbox6\" type=\"checkbox\" checked.bind=\"includeInBudget\" change.delegate=\"eventAggregator.publish('toggle element', 'Savings')\"><label for=\"checkbox6\"></label></div><a click.delegate=\"toggle()\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapseSavings\" aria-expanded=\"true\" aria-controls=\"collapseSavings\">Savings <span class=\"${collapsed ? 'glyphicon glyphicon-chevron-down arrows' : 'glyphicon glyphicon-chevron-up arrows'}\"></span></a></h5></div><div class=\"col-md-4 mb-0\"></div><div class=\"col-md-4\"><span class=\"${includeInBudget ? 'blackparagraph' : 'grayparagraph'}\">${cost | currency}</span><span class=\"permonth\">&nbsp&nbsp&nbsp/ Month</span></div></div><br><br><br><div id=\"collapseSavings\" class=\"collapse\" role=\"tabpanel\" aria-labelledby=\"headingSavings\"><div class=\"card-block\"><div class=\"btn-group btn-group-raised\" data-toggle=\"buttons\" click.delegate=\"toggleHorizon()\"><label class=\"btn btn-sm ${isMonthly ? 'btn-primary' : 'btn-secondary'}\">Monthly</label><label class=\"btn btn-sm ${!isMonthly ? 'btn-primary' : 'btn-secondary'}\">Yearly</label></div><div repeat.for=\"constant of constants.savings\" class=\"form-group\"><div class=\"input-group mb-2 mr-sm-2 mb-sm-0\"><label>${constant.label}</label><input type=\"number\" value.bind=\"$parent[constant.variable]\" change.delegate=\"calculateAdvancedSavings()\"></div></div></div></div></div></template>"; });
define('text!budget-breakdown-module/category-modules/taxes/taxes.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../utilities/currency\"></require><require from=\"../../../utilities/percent\"></require><div class=\"card\"><div class=\"card-header\" role=\"tab\" id=\"headingTaxes\"><div class=\"col-md-4\"><h5 class=\"mb-0\"><div class=\"checkbox checkbox checkbox-taxes checkbox-inline\"><input id=\"checkbox7\" type=\"checkbox\" checked.bind=\"includeInBudget\" change.delegate=\"eventAggregator.publish('toggle element', 'Taxes')\"><label for=\"checkbox7\"></label></div><a click.delegate=\"toggle()\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapseTaxes\" aria-expanded=\"true\" aria-controls=\"collapseTaxes\">Taxes <span class=\"${collapsed ? 'glyphicon glyphicon-chevron-down arrows' : 'glyphicon glyphicon-chevron-up arrows'}\"></span></a></h5></div><div class=\"col-md-4\"></div><div class=\"col-md-4\"><span class=\"${includeInBudget ? 'blackparagraph' : 'grayparagraph'}\">${cost | currency}</span><span class=\"permonth\">&nbsp&nbsp&nbsp/ Month</span></div></div><br><br><br><div id=\"collapseTaxes\" class=\"collapse\" role=\"tabpanel\" aria-labelledby=\"headingTaxes\"><div class=\"card-block\"><div class=\"btn-group btn-group-raised\" data-toggle=\"buttons\" click.delegate=\"toggleHorizon()\"><label class=\"btn btn-sm ${isMonthly ? 'btn-primary' : 'btn-secondary'}\">Monthly</label><label class=\"btn btn-sm ${!isMonthly ? 'btn-primary' : 'btn-secondary'}\">Yearly</label></div><div style=\"padding-bottom:1vh\" class=\"input-group mb-2 mr-sm-2 mb-sm-0\"><label>Gross Income After Taxes:</label>${grossIncome | currency}</div><div style=\"padding-bottom:1vh\" class=\"input-group mb-2 mr-sm-2 mb-sm-0\"><label>State Taxes:</label>${stateTaxCost | currency}</div><div class=\"input-group mb-2 mr-sm-2 mb-sm-0\"><label>Federal Taxes:</label>${federalTaxCost | currency}</div><div class=\"form-group\"><div class=\"input-group mb-2 mr-sm-2 mb-sm-0\"><label>Other Taxes:</label><input type=\"number\" value.bind=\"otherTaxCost\"></div></div></div></div></div></template>"; });
define('text!budget-breakdown-module/category-modules/transportation/transportation.html', ['module'], function(module) { module.exports = "<template><require from=\"../../../utilities/currency\"></require><require from=\"../../../utilities/percent\"></require><link rel=\"stylesheet\" href=\"//cdnjs.cloudflare.com/ajax/libs/font-awesome/4.2.0/css/font-awesome.min.css\"><div class=\"card\"><div class=\"card-header\" role=\"tab\" id=\"headingTransportation\"><dv class=\"col-md-4\"><h5 class=\"mb-0\"><div class=\"checkbox checkbox-transportation checkbox-inline\"><input id=\"checkbox8\" type=\"checkbox\" checked.bind=\"includeInBudget\" change.delegate=\"eventAggregator.publish('toggle element', 'Transportation')\"><label for=\"checkbox8\"></label></div><a click.delegate=\"toggle()\" data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#collapseTransportation\" aria-expanded=\"true\" aria-controls=\"collapseTransportation\">Transportation <span class=\"${collapsed ? 'glyphicon glyphicon-chevron-down arrows' : 'glyphicon glyphicon-chevron-up arrows'}\"></span></a></h5></dv></div><div class=\"col-md-4\"></div><div class=\"col-md-4\"><span class=\"${includeInBudget ? 'blackparagraph' : 'grayparagraph'}\">${cost | currency}</span><span class=\"permonth\">&nbsp&nbsp&nbsp/ Month</span></div><br><br><br><div id=\"collapseTransportation\" class=\"collapse\" role=\"tabpanel\" aria-labelledby=\"headingTransportation\"><div class=\"card-block\"><div class=\"btn-group btn-group-raised\" data-toggle=\"buttons\" click.delegate=\"toggleHorizon()\"><label class=\"btn btn-sm ${isMonthly ? 'btn-primary' : 'btn-secondary'}\">Monthly</label><label class=\"btn btn-sm ${!isMonthly ? 'btn-primary' : 'btn-secondary'}\">Yearly</label></div><div repeat.for=\"constant of constants.transportation\" class=\"form-group\"><div class=\"input-group mb-2 mr-sm-2 mb-sm-0\"><label>${constant.label}</label><input type=\"number\" value.bind=\"$parent[constant.variable]\" change.delegate=\"calculateAdvancedTransportationCost()\"></div></div></div></div></div></template>"; });
