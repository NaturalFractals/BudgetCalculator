...
define('text!five-year/donut-details.html', ['module'], function(module) { module.exports = "<template><div id=\"donut-details-div\"><h4>Your monthly ${currentExpense} for ${currentYear} is ${currentExpenseYearCost}</h4><div><h3>Top ways to save</h3><p>1) Cancel Club Memberships</p><p>2) Reduce or eliminate cable bill</p><p>3) Carpool/Reduce Transportation cost</p></div></div></template>"; });
