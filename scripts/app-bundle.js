...
define('utilities/chartFactory',['exports', 'highcharts'], function (exports, _highcharts) {
    ...
    var ChartFactory = exports.ChartFactory = function () {
        ...
        ChartFactory.createGaugeChart = function createGaugeChart(chartContainer, tuples) {
...
define('chart/gauge-chart',['exports', 'aurelia-framework', '../utilities/chartFactory', 'masterBudget'], function (exports, _aureliaFramework, _chartFactory, _masterBudget) {
    ...
    var GaugeChart = exports.GaugeChart = (_dec = (0, _aureliaFramework.inject)(_masterBudget.MasterBudget), _dec(_class = function () {
        function GaugeChart(masterBudget) {
        ...
        GaugeChart.prototype.attached = function attached() {
            var tuples = _chartFactory.ChartFactory.createChartTuple(this.masterBudget);
            this.chart = _chartFactory.ChartFactory.createGaugeChart('gaugeChartContainer', tuples);
            this.masterBudget.chart = this.chart;
        };
...
define('text!auto-budget/auto-budget.html', ['module'], function(module) { module.exports = "<template><div id=\"chart-div\"><compose view-model=\"chart/gauge-chart\"></compose></div></template>"; });
define('text!chart/gauge-chart.html', ['module'], function(module) { module.exports = "<template><require from=\"css/styles.css\"></require><require from=\"highcharts/css/highcharts.css\"></require><div id=\"gaugeChartContainer\" style=\"height:500px\"></div></template>"; });
