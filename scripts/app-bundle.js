...
define('text!goals/goals.html', ['module'], function(module) { module.exports = "<template><div><select name=\"goal-dropdown\"><option value=\"\">Buy a House</option><option value=\"\">Pay of Debt</option><option value=\"\">Save for Retirement</option><option value=\"\">Buy a Car</option><option value=\"\">Vacation</option><option value=\"\">Home Improvements</option><option value=\"\">Save for Emergency</option><option value=\"\">Gifts</option></select></div><div><input type=\"number\"></div></template>"; });
